...
export const teachersData: TeacherCardProps[] = [
  ...
  },
  {
    ...
    alt: 'Администратор',
    info: 'Основатель Школы, соавтор программы "Комплексное программа развития интеллекта". О себе: люблю создавать и растить (детей, деревья, цветы) ',
  },
  {
  ...
  },
  {
    ...
    alt: 'Программист',
    info: 'Работаю научным сотрудником в сфере динамики жидкости. Долгое время играл в шахматы, звание - мастер ФИДЕ. Создатель сайта Школы (ReactJS + FastAPI). Если что-то не работает, то вы знаете, кто в этом виноват',
  },
];
